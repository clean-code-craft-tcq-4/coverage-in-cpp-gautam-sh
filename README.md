...
1. Would try to write function and classes that satisfies single responsibilty principle.
2. Would try to write code with low cyclomatic complexity.
3. Would try to write tests for the function and classes.
